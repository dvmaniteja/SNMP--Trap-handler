...
traphandle 1.3.6.1.4.1.41717.10.* perl /var/www/html/et2536-vedb15/assignment3/trapDaemon.pl
...
7). Open localhost/et2536-vedb15/assignment3/index.php, where you can see the status of the device. 
