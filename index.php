...
<!-- Device input -->		
		<form method = "post">
		<table border=1 align="center" style="border-radius:10px;padding:10px" >
		<div><h2 style="color:black; padding:20px;" align=center style="font-family:verdana;color:black">Enter the details of the device</h2></div>
<div>
		...
		<?php 	
			...
			$sql3 = "select * from `mani_trapdevice`";
...
#Entering values into the database		
		$sql = "CREATE TABLE IF NOT EXISTS `mani_trapdevice`(`id` int(11) NOT NULL,`ip` VARCHAR(100) NOT NULL,`port` VARCHAR(40) NOT NULL,`community` VARCHAR(100) NOT NULL,PRIMARY KEY( `id` ))";
...
{		#echo "Table created successfully\n";
		...
		$sql1 = "INSERT INTO `mani_trapdevice` ".
		       "(`ip`,`port`,`community`) ".
		       "VALUES ".
		       "('$ip','$port','$com')";
...
$sql4="SELECT * FROM mani_traps";

$result2=$link->query($sql4);

echo '<table border=1 align="center"  style="border-radius:10px;padding:10px" >
<tr>
<th>ID</th>
<th>Status</th>
<th>IP Address</th>
